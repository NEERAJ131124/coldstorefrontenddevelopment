...
const RefundPolicy: React.FC = () => {
    return (
        <>
            <AuthHeader />
            <Container className="mt-5 mx-3" style={{ minHeight: "550px" }}>
                <Row>
                    <Col sm={12}>
                        <Card>
                            ...
                            <CardBody>
                                <H5>Thank you for choosing our services/products. We aim to provide the highest quality and satisfaction to our customers. However, we would like to inform you that:</H5>
                                <P className="text-danger">
                                    <strong>All purchases are final and non-refundable.</strong>
                                </P>

                                <H5 className="mt-4">Why No Refunds?</H5>
                                <P>Our policy of no refunds is in place due to the nature of our services/products, which involve:</P>
                                <ul>
                                    <li>Digital goods or services that are instantly delivered.</li>
                                    <li>Personalized or customized products that cannot be resold.</li>
                                ...
                                <ul>
                                    <li>An error on our part that led to an incorrect or undelivered product/service.</li>
                                    <li>Technical issues that prevent you from accessing the product/service for which payment was made.</li>
                                </ul>
